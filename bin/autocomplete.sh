...
_wpuplugincreator_complete() {
    ...
    local modules_list="WPUBaseAdminDatas WPUBaseAdminPage WPUBaseCron WPUBaseMessages WPUBaseSettings WPUBaseUpdate WPUBaseFields WPUBaseEmail WPUBaseToolbox WPUBaseFileCache WPUBaseModal WPUBaseNotify";
