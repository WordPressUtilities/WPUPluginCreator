...
_TRANSLATION_FILE="${_TRANSLATION_DIR}${translation_lang}.po";
...
translation_string="load_plugin_textdomain('wpucommentmetas', false, dirname(plugin_basename(__FILE__)) . '/lang/');";
